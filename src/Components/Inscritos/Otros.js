                ...
                <Container className='cur'>
                    ...
                    <Table className='tableta' striped bordered hover variant="dark" responsive>
                        <thead>
                            ...
                            <th colSpan={6}>PRACTICA DE TIRO O MANEJO DE ARMAS</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                    ...
                    <Table className='tableta' striped bordered hover variant="dark" responsive>
                        <thead>
                            <tr className='title_table'>
                            <th colSpan={6}>SEMINARIO JEFE DE OPERACIONES</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                    ...
                    <Table className='tableta' striped bordered hover variant="dark" responsive>
                        <thead>
                            <tr className='title_table'>
                            <th colSpan={6}>SEMINARIO JEFE DE RECURSOS HUMANOS</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                    ...
                    <Table className='tableta' striped bordered hover variant="dark" responsive>
                        <thead>
                            <tr className='title_table'>
                            <th colSpan={6}>CAPACITACIONES ADICIONALES </th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                        ...
                        <tr>
                            ...
                            <td>1.006.352.079</td>
                            <td>3218475774</td>
                            <td>Calle 10 #5-49 Palmira Valle</td>
                            </tr>
                            <tr>
                            <td>2</td>
                            <td>Alan Jacinto</td>
                            ...
                            <td>1.006.528.896</td>
                            <td>3206548976</td>
                            <td>Carrera 20 #3-50 Palmira Valle</td>
                            </tr>
                            <tr>
                            <td>3</td>
                            <td>Mark</td>

      ...
      <div>
                ...
                <Container className='cur'>
                    ...
                    <Table className='tableta' striped bordered hover variant="dark" responsive>
                        <thead>
                            <tr className='title_table'>
                                <th colSpan={6}>VIGILANCIA (60 HORAS)</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                    ...
                    <Table className='tableta' striped bordered hover variant="dark" responsive>
                        <thead>
                            <tr className='title_table'>
                            <th colSpan={6}>SUPERVISOR (60 HORAS)</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                    ...
                    <Table className='tableta' striped bordered hover variant="dark" responsive>
                        <thead>
                            <tr className='title_table'>
                            <th colSpan={6}>COMPETENTE LABORAL</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
...
export default Especialización;

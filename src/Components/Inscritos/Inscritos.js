            ...
            <NavbarApp/>
                <Container className='cur'>
                    ...
                    <Table className='tableta' striped bordered hover variant="dark" responsive>
                        <thead>
                            <tr className='title_table'>
                            <th colSpan={6}>MEDIOS TECNOLOGICOS </th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                    ...
                    <Table className='tableta' striped bordered hover variant="dark" responsive>
                        <thead>
                            <tr className='title_table'>
                            <th colSpan={6}>PROTECCION A DICNATARIOS</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                    ...
                    <Table className='tableta' striped bordered hover variant="dark" responsive>
                        <thead>
                            <tr className='title_table'>
                            <th colSpan={6}>CURSO ESCOLTA OFENSIVA Y DEFENSIVA</th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
